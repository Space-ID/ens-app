...
import WithdrawListIcon from 'components/Icons/WithdrawListIcon'
import WithdrawListModal from './WithdrawListModal'
...
export default function Withdraw() {
  ...
  return (
    <>
      ...
      <WithdrawListModal open={showList} onOpenChange={setShowList} />
    </>
  )
}
